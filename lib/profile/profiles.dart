              ...
              Container(
                ...
                decoration: const BoxDecoration(
                  image: DecorationImage(
                    image: AssetImage('assets/genres/header.jpg'), // Replace with your actual image path
                    fit: BoxFit.cover,
                  ),
                ),
                child:  const Padding(
                            ...
                            children: [
                              TextButton(
                                ...
                                style: TextButton.styleFrom(
                                  backgroundColor: Colors.transparent,
                                  side: const BorderSide(color: Colors.white), // Thêm border color là màu trắng
                                ),
                                child: const Text(
                                  'Follow',
                                  style: TextStyle(
                          ...
                          style: TextStyle(
                           ...
                           Expanded(
                             child: ListView.builder(
                                ...
                                itemCount: 9,
                                itemBuilder: (context, index) => const SongOfArtist(song: song)
                                                       ),
                           ),
